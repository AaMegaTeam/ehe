...
function show_supergroup_settingsall(msg, target)
  ...
  local settings = data[tostring(target)]['settings']
 local text = "<i>SuperGroup settings for ["..msg.to.print_name.."]</i>:\n\n[🔐] <code>Default locks</code> :\n<b>Lock links</b> 👉 "..settings.lock_link.."\n<b>Lock flood</b> 👉 "..settings.flood.."\n<b>Lock spam</b> 👉 "..settings.lock_spam.."\n<b>Lock Arabic</b> 👉 "..settings.lock_arabic.."\n<b>Lock Member</b> 👉 "..settings.lock_member.."\n<b>Lock RTL</b> 👉 "..settings.lock_rtl.."\n<b>Lock Tgservice</b>  👉 "..settings.lock_tgservice.."\n<b>Lock sticker</b> 👉 "..settings.lock_sticker.."\n\n[🔏] New locks :\n<b>Lock media</b> 👉 "..settings.lock_media.."\n<b>Lock fwd</b> 👉 "..settings.lock_fwd.."\n<b>Lock reply</b> 👉 "..settings.lock_reply.."\n<b>Lock bots</b> 👉 "..settings.lock_bots.."\n<b>Lock share</b> 👉 "..settings.lock_share.."\n<b>Lock tag</b> 👉 "..settings.lock_tag.."\n<b>Lock number</b> 👉 "..settings.lock_number.."\n<b>Lock poker</b> 👉 "..settings.lock_poker.."\n<b>Lock audio</b> 👉 "..settings.lock_audio.."\n<b>Lock photo</b> 👉 "..settings.lock_photo.."\n<b>Lock video</b> 👉 "..settings.lock_video.."\n<b>Lock documents</b> 👉 "..settings.lock_documents.."\n<b>Lock text</b> 👉 "..settings.lock_text.."\n<b>Lock all</b> 👉 "..settings.lock_all.."\n<b>Lock gifs</b> 👉 "..settings.lock_gifs.."\n<b>Lock inline</b> 👉 "..settings.lock_inline.."\n<b>Lock cmd</b> 👉 "..settings.lock_cmd.."\n\n[🔧] OTHER:\n[👥] <b>Public</b> 👉 "..settings.public.."\n[📛] <b>Strict settings</b> 👉 "..settings.strict.."\n[👀]<b>Flood sensitivity 👉 "..NUM_MSG_MAX.."|20\n\n[👥] About SuperGroup:\nName: "..msg.to.print_name.."\nId: "..msg.to.id.."\n\n[😶] "..muted_user_list(msg.to.id)
 return text
end
